...
Add in some green tiles along the perimeter (only need the center line)
work thru the largest rectanges and test any red/greens inside the rectangle
'''
n = len(lines)
# list of reds
reds = [(0,0)]*n
...
# cnt = 1860, area = 1652426442 (not right), A = (6216, 30095), B = (94876, 48734)
# cnt = 2304, area = 1641001348 (not right), A = (6829, 30095), B = (94876, 48734)
# cnt = 3412, area = 1614351200 (not right), A = (4939, 32107), B = (94876, 50058)
# cnt = 5370, area = 1574305000 (not right), A = (5375, 31143), B = (94876, 48734)
